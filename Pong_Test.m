...
% ------------TITLE-----------
    ...
    t(1)=text(.35,.75,'P','fontname','courier','fontsize',60,'color',[.15 .15 .15],'hor','center','fontweight','bold');
    t(2)=text(.45,.75,'O','fontname','courier','fontsize',60,'color',[.15 .15 .15],'hor','center','fontweight','bold');
    t(3)=text(.55,.75,'N','fontname','courier','fontsize',60,'color',[.15 .15 .15],'hor','center','fontweight','bold');
    t(4)=text(.65,.75,'G','fontname','courier','fontsize',60,'color',[.15 .15 .15],'hor','center','fontweight','bold');
    t(5)=text(.50,.55,'A tribute to the eponym game by ATARI Inc.','fontname','courier','fontsize',20,'color',[.15 .15 .15],'hor','center','fontweight','bold');
    t(6)=text(.50,.35,'by Jrme Briot','fontname','courier','fontsize',35,'color',[.15 .15 .15],'hor','center','fontweight','bold');
    t(7)=text(.50,.25,'edited by Alex Real','fontname','courier','fontsize',20,'color',[.15 .15 .15],'hor','center','fontweight','bold');

    map=gray(80);%mapping speed for title
